(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Html,Default,List,Web,Client,EventsPervasives,Concurrency,Remoting;
  ...
  Web:{
   Client:{
    ...
    Start:function(input,k)
    {
     ...
     {
      var x,f;
      x=Remoting.Async("SkyVue.Web:0",[input]);
      f=function(_arg1)
      {
       var x1;
       x1=k(_arg1);
